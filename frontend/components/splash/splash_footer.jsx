        ...
        <section>
            ...
            <nav>
                {[ 
                    ...
                    ["REACH OUT", "Megan McNulty", "(408) 656 5702", <a href="mailto:megan.mcnulty07@gmail.com">Email me</a>, <a href="https://www.linkedin.com/in/megan-mcnulty-26a2641b1/">LinkedIn</a>]
                ].map( (list, i) => <ul key={i} > { 
